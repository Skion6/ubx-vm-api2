...
echo Additional setup options available: --max-global-vms (-g), --dev-whitelist (-w), --max-free-vms, --max-premium-vms, --max-premium-vms-per-code, --max-cpu-threads, --max-ram-gb
echo Example: tools\setup.bat -g 20 -w "siteA,siteB" --max-free-vms 15 --max-premium-vms 5 --max-premium-vms-per-code 1 --max-cpu-threads 4 --max-ram-gb 8 --non-interactive
python setup.py %*
